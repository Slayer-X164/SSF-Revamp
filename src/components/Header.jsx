  ...
  return (
    <div className='flex w-7xl  items-center justify-between h-30'>
        ...
        <ul className='flex items-center gap-10 text-lg uppercase font-semibold'>
            ...
            <li className='cursor-pointer'><a href="#campaign">Campaign</a></li>
            <li className='cursor-pointer'><a href="#join-us">Join Us</a></li>
            <li className='flex items-center gap-1 cursor-pointer'>More<IoIosArrowDown /></li>
        </ul>
